...
const inventorSortByBirthYear = inventors.sort((a, b) => a.year - b.year);

console.log(inventorSortByBirthYear);
...
const inventorSortByAge = inventors.sort((a, b) => (b.passed - b.year) - (a.passed - a.year));

console.log(inventorSortByAge);
...
const inventorEdison = inventors.find((inventor) => {
